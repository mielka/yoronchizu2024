...
このリポジトリは、JAPAN CHOICEの選挙サービスから世論地図の部分を切り出し、より広いコミュニティでの利用と開発を可能にするためにオープンソース化したものです。
...
データの使用方法については [README.ipynb](README.ipynb) を参考にしてください。
